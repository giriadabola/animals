        ...
        animalForm.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const animalData = {
                    ...
                    magnordem: document.getElementById('magnordem')?.value.trim() || '',
                    ...
                    parvordem: document.getElementById('parvordem')?.value.trim() || '',
                    subfamilia: document.getElementById('subfamilia')?.value.trim() || '',
                    tribo: document.getElementById('tribo')?.value.trim() || '',
                    ...
                    taxonomiaFontes: typeof window.getTaxonomySourceUrls === 'function'
                    ...
                    informacao: {
                        ...
                        curiosidades: {
                            ...
                            tipoComunicacao: getPreferredGeneralVisualValue(getGeneralVisualData(), 'Tipo de Comunicação'),
                            tipoComunicacaoDescricao: curiosidadesCommunicationDescriptions[getPreferredGeneralVisualValue(getGeneralVisualData(), 'Tipo de Comunicação')] || '',
